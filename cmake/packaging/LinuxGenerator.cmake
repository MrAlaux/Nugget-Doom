...
if(NOT LINUXDEPLOY_EXECUTABLE)
    if(NOT CPACK_SYSTEM_PROCESSOR IN_LIST linuxdeploy_prebuilt_archs)
        message(
            FATAL_ERROR
                "linuxdeploy could not be found, and is not available to download for your system."
        )
    endif()
    ...
    execute_process(COMMAND chmod +x ${LINUXDEPLOY_EXECUTABLE} COMMAND_ECHO
                            STDOUT)
endif()
...
execute_process(
    COMMAND
        ...
        LDAI_UPDATE_INFORMATION=gh-releases-zsync|MrAlaux|Nugget-Doom|latest|${CPACK_PACKAGE_NAME}-*-Linux.AppImage.zsync
