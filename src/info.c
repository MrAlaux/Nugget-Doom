...
state_t original_states[NUMSTATES] = {
  ...
  {SPR_BFE1,2|FF_FULLBRIGHT,8,{.pm = A_BFGSpray},S_BFGLAND4}, // S_BFGLAND3
  ...
  {SPR_MISL,1|FF_FULLBRIGHT,8,{.pm = A_Explode},S_EXPLODE2},  // S_EXPLODE1
  ...
  {SPR_PLAY,6,4,{.pm = A_Pain},S_PLAY}, // S_PLAY_PAIN2
  {SPR_PLAY,7,10,{NULL},S_PLAY_DIE2}, // S_PLAY_DIE1
  {SPR_PLAY,8,10,{.pm = A_PlayerScream},S_PLAY_DIE3}, // S_PLAY_DIE2
  {SPR_PLAY,9,10,{.pm = A_Fall},S_PLAY_DIE4}, // S_PLAY_DIE3
  ...
  {SPR_PLAY,15,5,{.pm = A_XScream},S_PLAY_XDIE3}, // S_PLAY_XDIE2
  {SPR_PLAY,16,5,{.pm = A_Fall},S_PLAY_XDIE4},  // S_PLAY_XDIE3
  ...
  {SPR_POSS,0,10,{.pm = A_Look},S_POSS_STND2},  // S_POSS_STND
  {SPR_POSS,1,10,{.pm = A_Look},S_POSS_STND}, // S_POSS_STND2
  {SPR_POSS,0,4,{.pm = A_Chase},S_POSS_RUN2}, // S_POSS_RUN1
  {SPR_POSS,0,4,{.pm = A_Chase},S_POSS_RUN3}, // S_POSS_RUN2
  {SPR_POSS,1,4,{.pm = A_Chase},S_POSS_RUN4}, // S_POSS_RUN3
  {SPR_POSS,1,4,{.pm = A_Chase},S_POSS_RUN5}, // S_POSS_RUN4
  {SPR_POSS,2,4,{.pm = A_Chase},S_POSS_RUN6}, // S_POSS_RUN5
  {SPR_POSS,2,4,{.pm = A_Chase},S_POSS_RUN7}, // S_POSS_RUN6
  {SPR_POSS,3,4,{.pm = A_Chase},S_POSS_RUN8}, // S_POSS_RUN7
  {SPR_POSS,3,4,{.pm = A_Chase},S_POSS_RUN1}, // S_POSS_RUN8
  {SPR_POSS,4,10,{.pm = A_FaceTarget},S_POSS_ATK2}, // S_POSS_ATK1
  {SPR_POSS,5,8,{.pm = A_PosAttack},S_POSS_ATK3}, // S_POSS_ATK2
  {SPR_POSS,4,8,{NULL},S_POSS_RUN1},  // S_POSS_ATK3
  {SPR_POSS,6,3,{NULL},S_POSS_PAIN2}, // S_POSS_PAIN
  {SPR_POSS,6,3,{.pm = A_Pain},S_POSS_RUN1},  // S_POSS_PAIN2
  {SPR_POSS,7,5,{NULL},S_POSS_DIE2},  // S_POSS_DIE1
  {SPR_POSS,8,5,{.pm = A_Scream},S_POSS_DIE3},  // S_POSS_DIE2
  {SPR_POSS,9,5,{.pm = A_Fall},S_POSS_DIE4},  // S_POSS_DIE3
  ...
  {SPR_POSS,13,5,{.pm = A_XScream},S_POSS_XDIE3}, // S_POSS_XDIE2
  {SPR_POSS,14,5,{.pm = A_Fall},S_POSS_XDIE4},  // S_POSS_XDIE3
  ...
  {SPR_SPOS,0,10,{.pm = A_Look},S_SPOS_STND2},  // S_SPOS_STND
  {SPR_SPOS,1,10,{.pm = A_Look},S_SPOS_STND}, // S_SPOS_STND2
  {SPR_SPOS,0,3,{.pm = A_Chase},S_SPOS_RUN2}, // S_SPOS_RUN1
  {SPR_SPOS,0,3,{.pm = A_Chase},S_SPOS_RUN3}, // S_SPOS_RUN2
  {SPR_SPOS,1,3,{.pm = A_Chase},S_SPOS_RUN4}, // S_SPOS_RUN3
  {SPR_SPOS,1,3,{.pm = A_Chase},S_SPOS_RUN5}, // S_SPOS_RUN4
  {SPR_SPOS,2,3,{.pm = A_Chase},S_SPOS_RUN6}, // S_SPOS_RUN5
  {SPR_SPOS,2,3,{.pm = A_Chase},S_SPOS_RUN7}, // S_SPOS_RUN6
  {SPR_SPOS,3,3,{.pm = A_Chase},S_SPOS_RUN8}, // S_SPOS_RUN7
  {SPR_SPOS,3,3,{.pm = A_Chase},S_SPOS_RUN1}, // S_SPOS_RUN8
  {SPR_SPOS,4,10,{.pm = A_FaceTarget},S_SPOS_ATK2}, // S_SPOS_ATK1
  {SPR_SPOS,5|FF_FULLBRIGHT,10,{.pm = A_SPosAttack},S_SPOS_ATK3}, // S_SPOS_ATK2
  {SPR_SPOS,4,10,{NULL},S_SPOS_RUN1}, // S_SPOS_ATK3
  {SPR_SPOS,6,3,{NULL},S_SPOS_PAIN2}, // S_SPOS_PAIN
  {SPR_SPOS,6,3,{.pm = A_Pain},S_SPOS_RUN1},  // S_SPOS_PAIN2
  {SPR_SPOS,7,5,{NULL},S_SPOS_DIE2},  // S_SPOS_DIE1
  {SPR_SPOS,8,5,{.pm = A_Scream},S_SPOS_DIE3},  // S_SPOS_DIE2
  {SPR_SPOS,9,5,{.pm = A_Fall},S_SPOS_DIE4},  // S_SPOS_DIE3
  ...
  {SPR_SPOS,13,5,{.pm = A_XScream},S_SPOS_XDIE3}, // S_SPOS_XDIE2
  {SPR_SPOS,14,5,{.pm = A_Fall},S_SPOS_XDIE4},  // S_SPOS_XDIE3
  ...
  {SPR_VILE,0,10,{.pm = A_Look},S_VILE_STND2},  // S_VILE_STND
  {SPR_VILE,1,10,{.pm = A_Look},S_VILE_STND}, // S_VILE_STND2
  {SPR_VILE,0,2,{.pm = A_VileChase},S_VILE_RUN2}, // S_VILE_RUN1
  {SPR_VILE,0,2,{.pm = A_VileChase},S_VILE_RUN3}, // S_VILE_RUN2
  {SPR_VILE,1,2,{.pm = A_VileChase},S_VILE_RUN4}, // S_VILE_RUN3
  {SPR_VILE,1,2,{.pm = A_VileChase},S_VILE_RUN5}, // S_VILE_RUN4
  {SPR_VILE,2,2,{.pm = A_VileChase},S_VILE_RUN6}, // S_VILE_RUN5
  {SPR_VILE,2,2,{.pm = A_VileChase},S_VILE_RUN7}, // S_VILE_RUN6
  {SPR_VILE,3,2,{.pm = A_VileChase},S_VILE_RUN8}, // S_VILE_RUN7
  {SPR_VILE,3,2,{.pm = A_VileChase},S_VILE_RUN9}, // S_VILE_RUN8
  {SPR_VILE,4,2,{.pm = A_VileChase},S_VILE_RUN10},  // S_VILE_RUN9
  {SPR_VILE,4,2,{.pm = A_VileChase},S_VILE_RUN11},  // S_VILE_RUN10
  {SPR_VILE,5,2,{.pm = A_VileChase},S_VILE_RUN12},  // S_VILE_RUN11
  {SPR_VILE,5,2,{.pm = A_VileChase},S_VILE_RUN1}, // S_VILE_RUN12
  {SPR_VILE,6|FF_FULLBRIGHT,0,{.pm = A_VileStart},S_VILE_ATK2}, // S_VILE_ATK1
  {SPR_VILE,6|FF_FULLBRIGHT,10,{.pm = A_FaceTarget},S_VILE_ATK3}, // S_VILE_ATK2
  {SPR_VILE,7|FF_FULLBRIGHT,8,{.pm = A_VileTarget},S_VILE_ATK4},  // S_VILE_ATK3
  {SPR_VILE,8|FF_FULLBRIGHT,8,{.pm = A_FaceTarget},S_VILE_ATK5},  // S_VILE_ATK4
  {SPR_VILE,9|FF_FULLBRIGHT,8,{.pm = A_FaceTarget},S_VILE_ATK6},  // S_VILE_ATK5
  {SPR_VILE,10|FF_FULLBRIGHT,8,{.pm = A_FaceTarget},S_VILE_ATK7},  // S_VILE_ATK6
  {SPR_VILE,11|FF_FULLBRIGHT,8,{.pm = A_FaceTarget},S_VILE_ATK8},  // S_VILE_ATK7
  {SPR_VILE,12|FF_FULLBRIGHT,8,{.pm = A_FaceTarget},S_VILE_ATK9},  // S_VILE_ATK8
  {SPR_VILE,13|FF_FULLBRIGHT,8,{.pm = A_FaceTarget},S_VILE_ATK10}, // S_VILE_ATK9
  {SPR_VILE,14|FF_FULLBRIGHT,8,{.pm = A_VileAttack},S_VILE_ATK11}, // S_VILE_ATK10
  ...
  {SPR_VILE,16,5,{.pm = A_Pain},S_VILE_RUN1}, // S_VILE_PAIN2
  {SPR_VILE,16,7,{NULL},S_VILE_DIE2}, // S_VILE_DIE1
  {SPR_VILE,17,7,{.pm = A_Scream},S_VILE_DIE3},  // S_VILE_DIE2
  {SPR_VILE,18,7,{.pm = A_Fall},S_VILE_DIE4}, // S_VILE_DIE3
  ...
  {SPR_FIRE,0|FF_FULLBRIGHT,2,{.pm = A_StartFire},S_FIRE2}, // S_FIRE1
  {SPR_FIRE,1|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE3},  // S_FIRE2
  {SPR_FIRE,0|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE4},  // S_FIRE3
  {SPR_FIRE,1|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE5},  // S_FIRE4
  {SPR_FIRE,2|FF_FULLBRIGHT,2,{.pm = A_FireCrackle},S_FIRE6}, // S_FIRE5
  {SPR_FIRE,1|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE7},  // S_FIRE6
  {SPR_FIRE,2|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE8},  // S_FIRE7
  {SPR_FIRE,1|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE9},  // S_FIRE8
  {SPR_FIRE,2|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE10}, // S_FIRE9
  {SPR_FIRE,3|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE11}, // S_FIRE10
  {SPR_FIRE,2|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE12}, // S_FIRE11
  {SPR_FIRE,3|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE13}, // S_FIRE12
  {SPR_FIRE,2|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE14}, // S_FIRE13
  {SPR_FIRE,3|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE15}, // S_FIRE14
  {SPR_FIRE,4|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE16}, // S_FIRE15
  {SPR_FIRE,3|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE17}, // S_FIRE16
  {SPR_FIRE,4|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE18}, // S_FIRE17
  {SPR_FIRE,3|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE19}, // S_FIRE18
  {SPR_FIRE,4|FF_FULLBRIGHT,2,{.pm = A_FireCrackle},S_FIRE20},  // S_FIRE19
  {SPR_FIRE,5|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE21}, // S_FIRE20
  {SPR_FIRE,4|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE22}, // S_FIRE21
  {SPR_FIRE,5|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE23}, // S_FIRE22
  {SPR_FIRE,4|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE24}, // S_FIRE23
  {SPR_FIRE,5|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE25}, // S_FIRE24
  {SPR_FIRE,6|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE26}, // S_FIRE25
  {SPR_FIRE,7|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE27}, // S_FIRE26
  {SPR_FIRE,6|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE28}, // S_FIRE27
  {SPR_FIRE,7|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE29}, // S_FIRE28
  {SPR_FIRE,6|FF_FULLBRIGHT,2,{.pm = A_Fire},S_FIRE30}, // S_FIRE29
  {SPR_FIRE,7|FF_FULLBRIGHT,2,{.pm = A_Fire},S_NULL}, // S_FIRE30
  ...
  {SPR_FATB,0|FF_FULLBRIGHT,2,{.pm = A_Tracer},S_TRACER2},  // S_TRACER
  {SPR_FATB,1|FF_FULLBRIGHT,2,{.pm = A_Tracer},S_TRACER}, // S_TRACER2
  ...
  {SPR_SKEL,0,10,{.pm = A_Look},S_SKEL_STND2},  // S_SKEL_STND
  {SPR_SKEL,1,10,{.pm = A_Look},S_SKEL_STND}, // S_SKEL_STND2
  {SPR_SKEL,0,2,{.pm = A_Chase},S_SKEL_RUN2}, // S_SKEL_RUN1
  {SPR_SKEL,0,2,{.pm = A_Chase},S_SKEL_RUN3}, // S_SKEL_RUN2
  {SPR_SKEL,1,2,{.pm = A_Chase},S_SKEL_RUN4}, // S_SKEL_RUN3
  {SPR_SKEL,1,2,{.pm = A_Chase},S_SKEL_RUN5}, // S_SKEL_RUN4
  {SPR_SKEL,2,2,{.pm = A_Chase},S_SKEL_RUN6}, // S_SKEL_RUN5
  {SPR_SKEL,2,2,{.pm = A_Chase},S_SKEL_RUN7}, // S_SKEL_RUN6
  {SPR_SKEL,3,2,{.pm = A_Chase},S_SKEL_RUN8}, // S_SKEL_RUN7
  {SPR_SKEL,3,2,{.pm = A_Chase},S_SKEL_RUN9}, // S_SKEL_RUN8
  {SPR_SKEL,4,2,{.pm = A_Chase},S_SKEL_RUN10},  // S_SKEL_RUN9
  {SPR_SKEL,4,2,{.pm = A_Chase},S_SKEL_RUN11},  // S_SKEL_RUN10
  {SPR_SKEL,5,2,{.pm = A_Chase},S_SKEL_RUN12},  // S_SKEL_RUN11
  {SPR_SKEL,5,2,{.pm = A_Chase},S_SKEL_RUN1}, // S_SKEL_RUN12
  {SPR_SKEL,6,0,{.pm = A_FaceTarget},S_SKEL_FIST2}, // S_SKEL_FIST1
  {SPR_SKEL,6,6,{.pm = A_SkelWhoosh},S_SKEL_FIST3}, // S_SKEL_FIST2
  {SPR_SKEL,7,6,{.pm = A_FaceTarget},S_SKEL_FIST4}, // S_SKEL_FIST3
  {SPR_SKEL,8,6,{.pm = A_SkelFist},S_SKEL_RUN1},  // S_SKEL_FIST4
  {SPR_SKEL,9|FF_FULLBRIGHT,0,{.pm = A_FaceTarget},S_SKEL_MISS2}, // S_SKEL_MISS1
  {SPR_SKEL,9|FF_FULLBRIGHT,10,{.pm = A_FaceTarget},S_SKEL_MISS3},  // S_SKEL_MISS2
  {SPR_SKEL,10,10,{.pm = A_SkelMissile},S_SKEL_MISS4},  // S_SKEL_MISS3
  {SPR_SKEL,10,10,{.pm = A_FaceTarget},S_SKEL_RUN1},  // S_SKEL_MISS4
  {SPR_SKEL,11,5,{NULL},S_SKEL_PAIN2},  // S_SKEL_PAIN
  {SPR_SKEL,11,5,{.pm = A_Pain},S_SKEL_RUN1}, // S_SKEL_PAIN2
  {SPR_SKEL,11,7,{NULL},S_SKEL_DIE2}, // S_SKEL_DIE1
  {SPR_SKEL,12,7,{NULL},S_SKEL_DIE3}, // S_SKEL_DIE2
  {SPR_SKEL,13,7,{.pm = A_Scream},S_SKEL_DIE4}, // S_SKEL_DIE3
  {SPR_SKEL,14,7,{.pm = A_Fall},S_SKEL_DIE5}, // S_SKEL_DIE4
  ...
  {SPR_FATT,0,15,{.pm = A_Look},S_FATT_STND2},  // S_FATT_STND
  {SPR_FATT,1,15,{.pm = A_Look},S_FATT_STND}, // S_FATT_STND2
  {SPR_FATT,0,4,{.pm = A_Chase},S_FATT_RUN2}, // S_FATT_RUN1
  {SPR_FATT,0,4,{.pm = A_Chase},S_FATT_RUN3}, // S_FATT_RUN2
  {SPR_FATT,1,4,{.pm = A_Chase},S_FATT_RUN4}, // S_FATT_RUN3
  {SPR_FATT,1,4,{.pm = A_Chase},S_FATT_RUN5}, // S_FATT_RUN4
  {SPR_FATT,2,4,{.pm = A_Chase},S_FATT_RUN6}, // S_FATT_RUN5
  {SPR_FATT,2,4,{.pm = A_Chase},S_FATT_RUN7}, // S_FATT_RUN6
  {SPR_FATT,3,4,{.pm = A_Chase},S_FATT_RUN8}, // S_FATT_RUN7
  {SPR_FATT,3,4,{.pm = A_Chase},S_FATT_RUN9}, // S_FATT_RUN8
  {SPR_FATT,4,4,{.pm = A_Chase},S_FATT_RUN10},  // S_FATT_RUN9
  {SPR_FATT,4,4,{.pm = A_Chase},S_FATT_RUN11},  // S_FATT_RUN10
  {SPR_FATT,5,4,{.pm = A_Chase},S_FATT_RUN12},  // S_FATT_RUN11
  {SPR_FATT,5,4,{.pm = A_Chase},S_FATT_RUN1}, // S_FATT_RUN12
  {SPR_FATT,6,20,{.pm = A_FatRaise},S_FATT_ATK2}, // S_FATT_ATK1
  {SPR_FATT,7|FF_FULLBRIGHT,10,{.pm = A_FatAttack1},S_FATT_ATK3}, // S_FATT_ATK2
  {SPR_FATT,8,5,{.pm = A_FaceTarget},S_FATT_ATK4},  // S_FATT_ATK3
  {SPR_FATT,6,5,{.pm = A_FaceTarget},S_FATT_ATK5},  // S_FATT_ATK4
  {SPR_FATT,7|FF_FULLBRIGHT,10,{.pm = A_FatAttack2},S_FATT_ATK6}, // S_FATT_ATK5
  {SPR_FATT,8,5,{.pm = A_FaceTarget},S_FATT_ATK7},  // S_FATT_ATK6
  {SPR_FATT,6,5,{.pm = A_FaceTarget},S_FATT_ATK8},  // S_FATT_ATK7
  {SPR_FATT,7|FF_FULLBRIGHT,10,{.pm = A_FatAttack3},S_FATT_ATK9}, // S_FATT_ATK8
  {SPR_FATT,8,5,{.pm = A_FaceTarget},S_FATT_ATK10}, // S_FATT_ATK9
  {SPR_FATT,6,5,{.pm = A_FaceTarget},S_FATT_RUN1},  // S_FATT_ATK10
  {SPR_FATT,9,3,{NULL},S_FATT_PAIN2}, // S_FATT_PAIN
  {SPR_FATT,9,3,{.pm = A_Pain},S_FATT_RUN1},  // S_FATT_PAIN2
  {SPR_FATT,10,6,{NULL},S_FATT_DIE2}, // S_FATT_DIE1
  {SPR_FATT,11,6,{.pm = A_Scream},S_FATT_DIE3}, // S_FATT_DIE2
  {SPR_FATT,12,6,{.pm = A_Fall},S_FATT_DIE4}, // S_FATT_DIE3
  ...
  {SPR_FATT,19,-1,{.pm = A_BossDeath},S_NULL},  // S_FATT_DIE10
  ...
  {SPR_CPOS,0,10,{.pm = A_Look},S_CPOS_STND2},  // S_CPOS_STND
  {SPR_CPOS,1,10,{.pm = A_Look},S_CPOS_STND}, // S_CPOS_STND2
  {SPR_CPOS,0,3,{.pm = A_Chase},S_CPOS_RUN2}, // S_CPOS_RUN1
  {SPR_CPOS,0,3,{.pm = A_Chase},S_CPOS_RUN3}, // S_CPOS_RUN2
  {SPR_CPOS,1,3,{.pm = A_Chase},S_CPOS_RUN4}, // S_CPOS_RUN3
  {SPR_CPOS,1,3,{.pm = A_Chase},S_CPOS_RUN5}, // S_CPOS_RUN4
  {SPR_CPOS,2,3,{.pm = A_Chase},S_CPOS_RUN6}, // S_CPOS_RUN5
  {SPR_CPOS,2,3,{.pm = A_Chase},S_CPOS_RUN7}, // S_CPOS_RUN6
  {SPR_CPOS,3,3,{.pm = A_Chase},S_CPOS_RUN8}, // S_CPOS_RUN7
  {SPR_CPOS,3,3,{.pm = A_Chase},S_CPOS_RUN1}, // S_CPOS_RUN8
  {SPR_CPOS,4,10,{.pm = A_FaceTarget},S_CPOS_ATK2}, // S_CPOS_ATK1
  {SPR_CPOS,5|FF_FULLBRIGHT,4,{.pm = A_CPosAttack},S_CPOS_ATK3},  // S_CPOS_ATK2
  {SPR_CPOS,4|FF_FULLBRIGHT,4,{.pm = A_CPosAttack},S_CPOS_ATK4},  // S_CPOS_ATK3
  {SPR_CPOS,5,1,{.pm = A_CPosRefire},S_CPOS_ATK2},  // S_CPOS_ATK4
  {SPR_CPOS,6,3,{NULL},S_CPOS_PAIN2}, // S_CPOS_PAIN
  {SPR_CPOS,6,3,{.pm = A_Pain},S_CPOS_RUN1},  // S_CPOS_PAIN2
  {SPR_CPOS,7,5,{NULL},S_CPOS_DIE2},  // S_CPOS_DIE1
  {SPR_CPOS,8,5,{.pm = A_Scream},S_CPOS_DIE3},  // S_CPOS_DIE2
  {SPR_CPOS,9,5,{.pm = A_Fall},S_CPOS_DIE4},  // S_CPOS_DIE3
  ...
  {SPR_CPOS,15,5,{.pm = A_XScream},S_CPOS_XDIE3}, // S_CPOS_XDIE2
  {SPR_CPOS,16,5,{.pm = A_Fall},S_CPOS_XDIE4},  // S_CPOS_XDIE3
  ...
  {SPR_TROO,0,10,{.pm = A_Look},S_TROO_STND2},  // S_TROO_STND
  {SPR_TROO,1,10,{.pm = A_Look},S_TROO_STND}, // S_TROO_STND2
  {SPR_TROO,0,3,{.pm = A_Chase},S_TROO_RUN2}, // S_TROO_RUN1
  {SPR_TROO,0,3,{.pm = A_Chase},S_TROO_RUN3}, // S_TROO_RUN2
  {SPR_TROO,1,3,{.pm = A_Chase},S_TROO_RUN4}, // S_TROO_RUN3
  {SPR_TROO,1,3,{.pm = A_Chase},S_TROO_RUN5}, // S_TROO_RUN4
  {SPR_TROO,2,3,{.pm = A_Chase},S_TROO_RUN6}, // S_TROO_RUN5
  {SPR_TROO,2,3,{.pm = A_Chase},S_TROO_RUN7}, // S_TROO_RUN6
  {SPR_TROO,3,3,{.pm = A_Chase},S_TROO_RUN8}, // S_TROO_RUN7
  {SPR_TROO,3,3,{.pm = A_Chase},S_TROO_RUN1}, // S_TROO_RUN8
  {SPR_TROO,4,8,{.pm = A_FaceTarget},S_TROO_ATK2},  // S_TROO_ATK1
  {SPR_TROO,5,8,{.pm = A_FaceTarget},S_TROO_ATK3},  // S_TROO_ATK2
  {SPR_TROO,6,6,{.pm = A_TroopAttack},S_TROO_RUN1}, // S_TROO_ATK3
  {SPR_TROO,7,2,{NULL},S_TROO_PAIN2}, // S_TROO_PAIN
  {SPR_TROO,7,2,{.pm = A_Pain},S_TROO_RUN1},  // S_TROO_PAIN2
  {SPR_TROO,8,8,{NULL},S_TROO_DIE2},  // S_TROO_DIE1
  {SPR_TROO,9,8,{.pm = A_Scream},S_TROO_DIE3},  // S_TROO_DIE2
  {SPR_TROO,10,6,{NULL},S_TROO_DIE4}, // S_TROO_DIE3
  {SPR_TROO,11,6,{.pm = A_Fall},S_TROO_DIE5}, // S_TROO_DIE4
  {SPR_TROO,12,-1,{NULL},S_NULL}, // S_TROO_DIE5
  {SPR_TROO,13,5,{NULL},S_TROO_XDIE2},  // S_TROO_XDIE1
  {SPR_TROO,14,5,{.pm = A_XScream},S_TROO_XDIE3}, // S_TROO_XDIE2
  {SPR_TROO,15,5,{NULL},S_TROO_XDIE4},  // S_TROO_XDIE3
  {SPR_TROO,16,5,{.pm = A_Fall},S_TROO_XDIE5},  // S_TROO_XDIE4
  ...
  {SPR_SARG,0,10,{.pm = A_Look},S_SARG_STND2},  // S_SARG_STND
  {SPR_SARG,1,10,{.pm = A_Look},S_SARG_STND}, // S_SARG_STND2
  {SPR_SARG,0,2,{.pm = A_Chase},S_SARG_RUN2}, // S_SARG_RUN1
  {SPR_SARG,0,2,{.pm = A_Chase},S_SARG_RUN3}, // S_SARG_RUN2
  {SPR_SARG,1,2,{.pm = A_Chase},S_SARG_RUN4}, // S_SARG_RUN3
  {SPR_SARG,1,2,{.pm = A_Chase},S_SARG_RUN5}, // S_SARG_RUN4
  {SPR_SARG,2,2,{.pm = A_Chase},S_SARG_RUN6}, // S_SARG_RUN5
  {SPR_SARG,2,2,{.pm = A_Chase},S_SARG_RUN7}, // S_SARG_RUN6
  {SPR_SARG,3,2,{.pm = A_Chase},S_SARG_RUN8}, // S_SARG_RUN7
  {SPR_SARG,3,2,{.pm = A_Chase},S_SARG_RUN1}, // S_SARG_RUN8
  {SPR_SARG,4,8,{.pm = A_FaceTarget},S_SARG_ATK2},  // S_SARG_ATK1
  {SPR_SARG,5,8,{.pm = A_FaceTarget},S_SARG_ATK3},  // S_SARG_ATK2
  {SPR_SARG,6,8,{.pm = A_SargAttack},S_SARG_RUN1},  // S_SARG_ATK3
  {SPR_SARG,7,2,{NULL},S_SARG_PAIN2}, // S_SARG_PAIN
  {SPR_SARG,7,2,{.pm = A_Pain},S_SARG_RUN1},  // S_SARG_PAIN2
  {SPR_SARG,8,8,{NULL},S_SARG_DIE2},  // S_SARG_DIE1
  {SPR_SARG,9,8,{.pm = A_Scream},S_SARG_DIE3},  // S_SARG_DIE2
  {SPR_SARG,10,4,{NULL},S_SARG_DIE4}, // S_SARG_DIE3
  {SPR_SARG,11,4,{.pm = A_Fall},S_SARG_DIE5}, // S_SARG_DIE4
  ...
  {SPR_HEAD,0,10,{.pm = A_Look},S_HEAD_STND}, // S_HEAD_STND
  {SPR_HEAD,0,3,{.pm = A_Chase},S_HEAD_RUN1}, // S_HEAD_RUN1
  {SPR_HEAD,1,5,{.pm = A_FaceTarget},S_HEAD_ATK2},  // S_HEAD_ATK1
  {SPR_HEAD,2,5,{.pm = A_FaceTarget},S_HEAD_ATK3},  // S_HEAD_ATK2
  {SPR_HEAD,3|FF_FULLBRIGHT,5,{.pm = A_HeadAttack},S_HEAD_RUN1},  // S_HEAD_ATK3
  {SPR_HEAD,4,3,{NULL},S_HEAD_PAIN2}, // S_HEAD_PAIN
  {SPR_HEAD,4,3,{.pm = A_Pain},S_HEAD_PAIN3}, // S_HEAD_PAIN2
  {SPR_HEAD,5,6,{NULL},S_HEAD_RUN1},  // S_HEAD_PAIN3
  {SPR_HEAD,6,8,{NULL},S_HEAD_DIE2},  // S_HEAD_DIE1
  {SPR_HEAD,7,8,{.pm = A_Scream},S_HEAD_DIE3},  // S_HEAD_DIE2
  {SPR_HEAD,8,8,{NULL},S_HEAD_DIE4},  // S_HEAD_DIE3
  {SPR_HEAD,9,8,{NULL},S_HEAD_DIE5},  // S_HEAD_DIE4
  {SPR_HEAD,10,8,{.pm = A_Fall},S_HEAD_DIE6}, // S_HEAD_DIE5
  ...
  {SPR_BOSS,0,10,{.pm = A_Look},S_BOSS_STND2},  // S_BOSS_STND
  {SPR_BOSS,1,10,{.pm = A_Look},S_BOSS_STND}, // S_BOSS_STND2
  {SPR_BOSS,0,3,{.pm = A_Chase},S_BOSS_RUN2}, // S_BOSS_RUN1
  {SPR_BOSS,0,3,{.pm = A_Chase},S_BOSS_RUN3}, // S_BOSS_RUN2
  {SPR_BOSS,1,3,{.pm = A_Chase},S_BOSS_RUN4}, // S_BOSS_RUN3
  {SPR_BOSS,1,3,{.pm = A_Chase},S_BOSS_RUN5}, // S_BOSS_RUN4
  {SPR_BOSS,2,3,{.pm = A_Chase},S_BOSS_RUN6}, // S_BOSS_RUN5
  {SPR_BOSS,2,3,{.pm = A_Chase},S_BOSS_RUN7}, // S_BOSS_RUN6
  {SPR_BOSS,3,3,{.pm = A_Chase},S_BOSS_RUN8}, // S_BOSS_RUN7
  {SPR_BOSS,3,3,{.pm = A_Chase},S_BOSS_RUN1}, // S_BOSS_RUN8
  {SPR_BOSS,4,8,{.pm = A_FaceTarget},S_BOSS_ATK2},  // S_BOSS_ATK1
  {SPR_BOSS,5,8,{.pm = A_FaceTarget},S_BOSS_ATK3},  // S_BOSS_ATK2
  {SPR_BOSS,6,8,{.pm = A_BruisAttack},S_BOSS_RUN1}, // S_BOSS_ATK3
  {SPR_BOSS,7,2,{NULL},S_BOSS_PAIN2}, // S_BOSS_PAIN
  {SPR_BOSS,7,2,{.pm = A_Pain},S_BOSS_RUN1},  // S_BOSS_PAIN2
  {SPR_BOSS,8,8,{NULL},S_BOSS_DIE2},  // S_BOSS_DIE1
  {SPR_BOSS,9,8,{.pm = A_Scream},S_BOSS_DIE3},  // S_BOSS_DIE2
  {SPR_BOSS,10,8,{NULL},S_BOSS_DIE4}, // S_BOSS_DIE3
  {SPR_BOSS,11,8,{.pm = A_Fall},S_BOSS_DIE5}, // S_BOSS_DIE4
  {SPR_BOSS,12,8,{NULL},S_BOSS_DIE6}, // S_BOSS_DIE5
  {SPR_BOSS,13,8,{NULL},S_BOSS_DIE7}, // S_BOSS_DIE6
  {SPR_BOSS,14,-1,{.pm = A_BossDeath},S_NULL},  // S_BOSS_DIE7
  ...
  {SPR_BOS2,0,10,{.pm = A_Look},S_BOS2_STND2},  // S_BOS2_STND
  {SPR_BOS2,1,10,{.pm = A_Look},S_BOS2_STND}, // S_BOS2_STND2
  {SPR_BOS2,0,3,{.pm = A_Chase},S_BOS2_RUN2}, // S_BOS2_RUN1
  {SPR_BOS2,0,3,{.pm = A_Chase},S_BOS2_RUN3}, // S_BOS2_RUN2
  {SPR_BOS2,1,3,{.pm = A_Chase},S_BOS2_RUN4}, // S_BOS2_RUN3
  {SPR_BOS2,1,3,{.pm = A_Chase},S_BOS2_RUN5}, // S_BOS2_RUN4
  {SPR_BOS2,2,3,{.pm = A_Chase},S_BOS2_RUN6}, // S_BOS2_RUN5
  {SPR_BOS2,2,3,{.pm = A_Chase},S_BOS2_RUN7}, // S_BOS2_RUN6
  {SPR_BOS2,3,3,{.pm = A_Chase},S_BOS2_RUN8}, // S_BOS2_RUN7
  {SPR_BOS2,3,3,{.pm = A_Chase},S_BOS2_RUN1}, // S_BOS2_RUN8
  {SPR_BOS2,4,8,{.pm = A_FaceTarget},S_BOS2_ATK2},  // S_BOS2_ATK1
  {SPR_BOS2,5,8,{.pm = A_FaceTarget},S_BOS2_ATK3},  // S_BOS2_ATK2
  {SPR_BOS2,6,8,{.pm = A_BruisAttack},S_BOS2_RUN1}, // S_BOS2_ATK3
  {SPR_BOS2,7,2,{NULL},S_BOS2_PAIN2}, // S_BOS2_PAIN
  {SPR_BOS2,7,2,{.pm = A_Pain},S_BOS2_RUN1},  // S_BOS2_PAIN2
  {SPR_BOS2,8,8,{NULL},S_BOS2_DIE2},  // S_BOS2_DIE1
  {SPR_BOS2,9,8,{.pm = A_Scream},S_BOS2_DIE3},  // S_BOS2_DIE2
  {SPR_BOS2,10,8,{NULL},S_BOS2_DIE4}, // S_BOS2_DIE3
  {SPR_BOS2,11,8,{.pm = A_Fall},S_BOS2_DIE5}, // S_BOS2_DIE4
  ...
  {SPR_SKUL,0|FF_FULLBRIGHT,10,{.pm = A_Look},S_SKULL_STND2}, // S_SKULL_STND
  {SPR_SKUL,1|FF_FULLBRIGHT,10,{.pm = A_Look},S_SKULL_STND},  // S_SKULL_STND2
  {SPR_SKUL,0|FF_FULLBRIGHT,6,{.pm = A_Chase},S_SKULL_RUN2},  // S_SKULL_RUN1
  {SPR_SKUL,1|FF_FULLBRIGHT,6,{.pm = A_Chase},S_SKULL_RUN1},  // S_SKULL_RUN2
  {SPR_SKUL,2|FF_FULLBRIGHT,10,{.pm = A_FaceTarget},S_SKULL_ATK2},  // S_SKULL_ATK1
  {SPR_SKUL,3|FF_FULLBRIGHT,4,{.pm = A_SkullAttack},S_SKULL_ATK3},  // S_SKULL_ATK2
  ...
  {SPR_SKUL,4|FF_FULLBRIGHT,3,{.pm = A_Pain},S_SKULL_RUN1}, // S_SKULL_PAIN2
  {SPR_SKUL,5|FF_FULLBRIGHT,6,{NULL},S_SKULL_DIE2}, // S_SKULL_DIE1
  {SPR_SKUL,6|FF_FULLBRIGHT,6,{.pm = A_Scream},S_SKULL_DIE3}, // S_SKULL_DIE2
  {SPR_SKUL,7|FF_FULLBRIGHT,6,{NULL},S_SKULL_DIE4}, // S_SKULL_DIE3
  {SPR_SKUL,8|FF_FULLBRIGHT,6,{.pm = A_Fall},S_SKULL_DIE5}, // S_SKULL_DIE4
  {SPR_SKUL,9,6,{NULL},S_SKULL_DIE6}, // S_SKULL_DIE5
  {SPR_SKUL,10,6,{NULL},S_NULL},  // S_SKULL_DIE6
  {SPR_SPID,0,10,{.pm = A_Look},S_SPID_STND2},  // S_SPID_STND
  {SPR_SPID,1,10,{.pm = A_Look},S_SPID_STND}, // S_SPID_STND2
  {SPR_SPID,0,3,{.pm = A_Metal},S_SPID_RUN2}, // S_SPID_RUN1
  {SPR_SPID,0,3,{.pm = A_Chase},S_SPID_RUN3}, // S_SPID_RUN2
  {SPR_SPID,1,3,{.pm = A_Chase},S_SPID_RUN4}, // S_SPID_RUN3
  {SPR_SPID,1,3,{.pm = A_Chase},S_SPID_RUN5}, // S_SPID_RUN4
  {SPR_SPID,2,3,{.pm = A_Metal},S_SPID_RUN6}, // S_SPID_RUN5
  {SPR_SPID,2,3,{.pm = A_Chase},S_SPID_RUN7}, // S_SPID_RUN6
  {SPR_SPID,3,3,{.pm = A_Chase},S_SPID_RUN8}, // S_SPID_RUN7
  {SPR_SPID,3,3,{.pm = A_Chase},S_SPID_RUN9}, // S_SPID_RUN8
  {SPR_SPID,4,3,{.pm = A_Metal},S_SPID_RUN10},  // S_SPID_RUN9
  {SPR_SPID,4,3,{.pm = A_Chase},S_SPID_RUN11},  // S_SPID_RUN10
  {SPR_SPID,5,3,{.pm = A_Chase},S_SPID_RUN12},  // S_SPID_RUN11
  {SPR_SPID,5,3,{.pm = A_Chase},S_SPID_RUN1}, // S_SPID_RUN12
  {SPR_SPID,0|FF_FULLBRIGHT,20,{.pm = A_FaceTarget},S_SPID_ATK2}, // S_SPID_ATK1
  {SPR_SPID,6|FF_FULLBRIGHT,4,{.pm = A_SPosAttack},S_SPID_ATK3},  // S_SPID_ATK2
  {SPR_SPID,7|FF_FULLBRIGHT,4,{.pm = A_SPosAttack},S_SPID_ATK4},  // S_SPID_ATK3
  {SPR_SPID,7|FF_FULLBRIGHT,1,{.pm = A_SpidRefire},S_SPID_ATK2},  // S_SPID_ATK4
  {SPR_SPID,8,3,{NULL},S_SPID_PAIN2}, // S_SPID_PAIN
  {SPR_SPID,8,3,{.pm = A_Pain},S_SPID_RUN1},  // S_SPID_PAIN2
  {SPR_SPID,9,20,{.pm = A_Scream},S_SPID_DIE2}, // S_SPID_DIE1
  {SPR_SPID,10,10,{.pm = A_Fall},S_SPID_DIE3},  // S_SPID_DIE2
  ...
  {SPR_SPID,18,-1,{.pm = A_BossDeath},S_NULL},  // S_SPID_DIE11
  {SPR_BSPI,0,10,{.pm = A_Look},S_BSPI_STND2},  // S_BSPI_STND
  {SPR_BSPI,1,10,{.pm = A_Look},S_BSPI_STND}, // S_BSPI_STND2
  {SPR_BSPI,0,20,{NULL},S_BSPI_RUN1}, // S_BSPI_SIGHT
  {SPR_BSPI,0,3,{.pm = A_BabyMetal},S_BSPI_RUN2}, // S_BSPI_RUN1
  {SPR_BSPI,0,3,{.pm = A_Chase},S_BSPI_RUN3}, // S_BSPI_RUN2
  {SPR_BSPI,1,3,{.pm = A_Chase},S_BSPI_RUN4}, // S_BSPI_RUN3
  {SPR_BSPI,1,3,{.pm = A_Chase},S_BSPI_RUN5}, // S_BSPI_RUN4
  {SPR_BSPI,2,3,{.pm = A_Chase},S_BSPI_RUN6}, // S_BSPI_RUN5
  {SPR_BSPI,2,3,{.pm = A_Chase},S_BSPI_RUN7}, // S_BSPI_RUN6
  {SPR_BSPI,3,3,{.pm = A_BabyMetal},S_BSPI_RUN8}, // S_BSPI_RUN7
  {SPR_BSPI,3,3,{.pm = A_Chase},S_BSPI_RUN9}, // S_BSPI_RUN8
  {SPR_BSPI,4,3,{.pm = A_Chase},S_BSPI_RUN10},  // S_BSPI_RUN9
  {SPR_BSPI,4,3,{.pm = A_Chase},S_BSPI_RUN11},  // S_BSPI_RUN10
  {SPR_BSPI,5,3,{.pm = A_Chase},S_BSPI_RUN12},  // S_BSPI_RUN11
  {SPR_BSPI,5,3,{.pm = A_Chase},S_BSPI_RUN1}, // S_BSPI_RUN12
  {SPR_BSPI,0|FF_FULLBRIGHT,20,{.pm = A_FaceTarget},S_BSPI_ATK2}, // S_BSPI_ATK1
  {SPR_BSPI,6|FF_FULLBRIGHT,4,{.pm = A_BspiAttack},S_BSPI_ATK3},  // S_BSPI_ATK2
  {SPR_BSPI,7|FF_FULLBRIGHT,4,{NULL},S_BSPI_ATK4},  // S_BSPI_ATK3
  {SPR_BSPI,7|FF_FULLBRIGHT,1,{.pm = A_SpidRefire},S_BSPI_ATK2},  // S_BSPI_ATK4
  {SPR_BSPI,8,3,{NULL},S_BSPI_PAIN2}, // S_BSPI_PAIN
  {SPR_BSPI,8,3,{.pm = A_Pain},S_BSPI_RUN1},  // S_BSPI_PAIN2
  {SPR_BSPI,9,20,{.pm = A_Scream},S_BSPI_DIE2}, // S_BSPI_DIE1
  {SPR_BSPI,10,7,{.pm = A_Fall},S_BSPI_DIE3}, // S_BSPI_DIE2
  ...
  {SPR_BSPI,15,-1,{.pm = A_BossDeath},S_NULL},  // S_BSPI_DIE7
  ...
  {SPR_CYBR,0,10,{.pm = A_Look},S_CYBER_STND2}, // S_CYBER_STND
  {SPR_CYBR,1,10,{.pm = A_Look},S_CYBER_STND},  // S_CYBER_STND2
  {SPR_CYBR,0,3,{.pm = A_Hoof},S_CYBER_RUN2}, // S_CYBER_RUN1
  {SPR_CYBR,0,3,{.pm = A_Chase},S_CYBER_RUN3},  // S_CYBER_RUN2
  {SPR_CYBR,1,3,{.pm = A_Chase},S_CYBER_RUN4},  // S_CYBER_RUN3
  {SPR_CYBR,1,3,{.pm = A_Chase},S_CYBER_RUN5},  // S_CYBER_RUN4
  {SPR_CYBR,2,3,{.pm = A_Chase},S_CYBER_RUN6},  // S_CYBER_RUN5
  {SPR_CYBR,2,3,{.pm = A_Chase},S_CYBER_RUN7},  // S_CYBER_RUN6
  {SPR_CYBR,3,3,{.pm = A_Metal},S_CYBER_RUN8},  // S_CYBER_RUN7
  {SPR_CYBR,3,3,{.pm = A_Chase},S_CYBER_RUN1},  // S_CYBER_RUN8
  {SPR_CYBR,4,6,{.pm = A_FaceTarget},S_CYBER_ATK2}, // S_CYBER_ATK1
  {SPR_CYBR,5,12,{.pm = A_CyberAttack},S_CYBER_ATK3}, // S_CYBER_ATK2
  {SPR_CYBR,4,12,{.pm = A_FaceTarget},S_CYBER_ATK4},  // S_CYBER_ATK3
  {SPR_CYBR,5,12,{.pm = A_CyberAttack},S_CYBER_ATK5}, // S_CYBER_ATK4
  {SPR_CYBR,4,12,{.pm = A_FaceTarget},S_CYBER_ATK6},  // S_CYBER_ATK5
  {SPR_CYBR,5,12,{.pm = A_CyberAttack},S_CYBER_RUN1}, // S_CYBER_ATK6
  {SPR_CYBR,6,10,{.pm = A_Pain},S_CYBER_RUN1},  // S_CYBER_PAIN
  {SPR_CYBR,7,10,{NULL},S_CYBER_DIE2},  // S_CYBER_DIE1
  {SPR_CYBR,8,10,{.pm = A_Scream},S_CYBER_DIE3},  // S_CYBER_DIE2
  ...
  {SPR_CYBR,12,10,{.pm = A_Fall},S_CYBER_DIE7}, // S_CYBER_DIE6
  ...
  {SPR_CYBR,15,-1,{.pm = A_BossDeath},S_NULL},  // S_CYBER_DIE10
  {SPR_PAIN,0,10,{.pm = A_Look},S_PAIN_STND}, // S_PAIN_STND
  {SPR_PAIN,0,3,{.pm = A_Chase},S_PAIN_RUN2}, // S_PAIN_RUN1
  {SPR_PAIN,0,3,{.pm = A_Chase},S_PAIN_RUN3}, // S_PAIN_RUN2
  {SPR_PAIN,1,3,{.pm = A_Chase},S_PAIN_RUN4}, // S_PAIN_RUN3
  {SPR_PAIN,1,3,{.pm = A_Chase},S_PAIN_RUN5}, // S_PAIN_RUN4
  {SPR_PAIN,2,3,{.pm = A_Chase},S_PAIN_RUN6}, // S_PAIN_RUN5
  {SPR_PAIN,2,3,{.pm = A_Chase},S_PAIN_RUN1}, // S_PAIN_RUN6
  {SPR_PAIN,3,5,{.pm = A_FaceTarget},S_PAIN_ATK2},  // S_PAIN_ATK1
  {SPR_PAIN,4,5,{.pm = A_FaceTarget},S_PAIN_ATK3},  // S_PAIN_ATK2
  {SPR_PAIN,5|FF_FULLBRIGHT,5,{.pm = A_FaceTarget},S_PAIN_ATK4},  // S_PAIN_ATK3
  {SPR_PAIN,5|FF_FULLBRIGHT,0,{.pm = A_PainAttack},S_PAIN_RUN1},  // S_PAIN_ATK4
  {SPR_PAIN,6,6,{NULL},S_PAIN_PAIN2}, // S_PAIN_PAIN
  {SPR_PAIN,6,6,{.pm = A_Pain},S_PAIN_RUN1},  // S_PAIN_PAIN2
  {SPR_PAIN,7|FF_FULLBRIGHT,8,{NULL},S_PAIN_DIE2},  // S_PAIN_DIE1
  {SPR_PAIN,8|FF_FULLBRIGHT,8,{.pm = A_Scream},S_PAIN_DIE3},  // S_PAIN_DIE2
  {SPR_PAIN,9|FF_FULLBRIGHT,8,{NULL},S_PAIN_DIE4},  // S_PAIN_DIE3
  {SPR_PAIN,10|FF_FULLBRIGHT,8,{NULL},S_PAIN_DIE5},  // S_PAIN_DIE4
  {SPR_PAIN,11|FF_FULLBRIGHT,8,{.pm = A_PainDie},S_PAIN_DIE6}, // S_PAIN_DIE5
  ...
  {SPR_SSWV,0,10,{.pm = A_Look},S_SSWV_STND2},  // S_SSWV_STND
  {SPR_SSWV,1,10,{.pm = A_Look},S_SSWV_STND}, // S_SSWV_STND2
  {SPR_SSWV,0,3,{.pm = A_Chase},S_SSWV_RUN2}, // S_SSWV_RUN1
  {SPR_SSWV,0,3,{.pm = A_Chase},S_SSWV_RUN3}, // S_SSWV_RUN2
  {SPR_SSWV,1,3,{.pm = A_Chase},S_SSWV_RUN4}, // S_SSWV_RUN3
  {SPR_SSWV,1,3,{.pm = A_Chase},S_SSWV_RUN5}, // S_SSWV_RUN4
  {SPR_SSWV,2,3,{.pm = A_Chase},S_SSWV_RUN6}, // S_SSWV_RUN5
  {SPR_SSWV,2,3,{.pm = A_Chase},S_SSWV_RUN7}, // S_SSWV_RUN6
  {SPR_SSWV,3,3,{.pm = A_Chase},S_SSWV_RUN8}, // S_SSWV_RUN7
  {SPR_SSWV,3,3,{.pm = A_Chase},S_SSWV_RUN1}, // S_SSWV_RUN8
  {SPR_SSWV,4,10,{.pm = A_FaceTarget},S_SSWV_ATK2}, // S_SSWV_ATK1
  {SPR_SSWV,5,10,{.pm = A_FaceTarget},S_SSWV_ATK3}, // S_SSWV_ATK2
  {SPR_SSWV,6|FF_FULLBRIGHT,4,{.pm = A_CPosAttack},S_SSWV_ATK4},  // S_SSWV_ATK3
  {SPR_SSWV,5,6,{.pm = A_FaceTarget},S_SSWV_ATK5},  // S_SSWV_ATK4
  {SPR_SSWV,6|FF_FULLBRIGHT,4,{.pm = A_CPosAttack},S_SSWV_ATK6},  // S_SSWV_ATK5
  {SPR_SSWV,5,1,{.pm = A_CPosRefire},S_SSWV_ATK2},  // S_SSWV_ATK6
  {SPR_SSWV,7,3,{NULL},S_SSWV_PAIN2}, // S_SSWV_PAIN
  {SPR_SSWV,7,3,{.pm = A_Pain},S_SSWV_RUN1},  // S_SSWV_PAIN2
  {SPR_SSWV,8,5,{NULL},S_SSWV_DIE2},  // S_SSWV_DIE1
  {SPR_SSWV,9,5,{.pm = A_Scream},S_SSWV_DIE3},  // S_SSWV_DIE2
  {SPR_SSWV,10,5,{.pm = A_Fall},S_SSWV_DIE4}, // S_SSWV_DIE3
  ...
  {SPR_SSWV,14,5,{.pm = A_XScream},S_SSWV_XDIE3}, // S_SSWV_XDIE2
  {SPR_SSWV,15,5,{.pm = A_Fall},S_SSWV_XDIE4},  // S_SSWV_XDIE3
  ...
  {SPR_KEEN,2,6,{.pm = A_Scream},S_COMMKEEN4},  // S_COMMKEEN3
  ...
  {SPR_KEEN,10,6,{.pm = A_KeenDie},S_COMMKEEN12},// S_COMMKEEN11
  {SPR_KEEN,11,-1,{NULL},S_NULL},   // S_COMMKEEN12
  {SPR_KEEN,12,4,{NULL},S_KEENPAIN2}, // S_KEENPAIN
  {SPR_KEEN,12,8,{.pm = A_Pain},S_KEENSTND},  // S_KEENPAIN2
  {SPR_BBRN,0,-1,{NULL},S_NULL},    // S_BRAIN
  {SPR_BBRN,1,36,{.pm = A_BrainPain},S_BRAIN},  // S_BRAIN_PAIN
  {SPR_BBRN,0,100,{.pm = A_BrainScream},S_BRAIN_DIE2},  // S_BRAIN_DIE1
  {SPR_BBRN,0,10,{NULL},S_BRAIN_DIE3},  // S_BRAIN_DIE2
  {SPR_BBRN,0,10,{NULL},S_BRAIN_DIE4},  // S_BRAIN_DIE3
  {SPR_BBRN,0,-1,{.pm = A_BrainDie},S_NULL},  // S_BRAIN_DIE4
  {SPR_SSWV,0,10,{.pm = A_Look},S_BRAINEYE},  // S_BRAINEYE
  {SPR_SSWV,0,181,{.pm = A_BrainAwake},S_BRAINEYE1},  // S_BRAINEYESEE
  {SPR_SSWV,0,150,{.pm = A_BrainSpit},S_BRAINEYE1}, // S_BRAINEYE1
  {SPR_BOSF,0|FF_FULLBRIGHT,3,{.pm = A_SpawnSound},S_SPAWN2}, // S_SPAWN1
  {SPR_BOSF,1|FF_FULLBRIGHT,3,{.pm = A_SpawnFly},S_SPAWN3}, // S_SPAWN2
  {SPR_BOSF,2|FF_FULLBRIGHT,3,{.pm = A_SpawnFly},S_SPAWN4}, // S_SPAWN3
  {SPR_BOSF,3|FF_FULLBRIGHT,3,{.pm = A_SpawnFly},S_SPAWN1}, // S_SPAWN4
  {SPR_FIRE,0|FF_FULLBRIGHT,4,{.pm = A_Fire},S_SPAWNFIRE2}, // S_SPAWNFIRE1
  {SPR_FIRE,1|FF_FULLBRIGHT,4,{.pm = A_Fire},S_SPAWNFIRE3}, // S_SPAWNFIRE2
  {SPR_FIRE,2|FF_FULLBRIGHT,4,{.pm = A_Fire},S_SPAWNFIRE4}, // S_SPAWNFIRE3
  {SPR_FIRE,3|FF_FULLBRIGHT,4,{.pm = A_Fire},S_SPAWNFIRE5}, // S_SPAWNFIRE4
  {SPR_FIRE,4|FF_FULLBRIGHT,4,{.pm = A_Fire},S_SPAWNFIRE6}, // S_SPAWNFIRE5
  {SPR_FIRE,5|FF_FULLBRIGHT,4,{.pm = A_Fire},S_SPAWNFIRE7}, // S_SPAWNFIRE6
  {SPR_FIRE,6|FF_FULLBRIGHT,4,{.pm = A_Fire},S_SPAWNFIRE8}, // S_SPAWNFIRE7
  {SPR_FIRE,7|FF_FULLBRIGHT,4,{.pm = A_Fire},S_NULL},   // S_SPAWNFIRE8
  ...
  {SPR_MISL,3|FF_FULLBRIGHT,10,{.pm = A_BrainExplode},S_NULL},  // S_BRAINEXPLODE3
  ...
  {SPR_BEXP,1|FF_FULLBRIGHT,5,{.pm = A_Scream},S_BEXP3},  // S_BEXP2
  {SPR_BEXP,2|FF_FULLBRIGHT,5,{NULL},S_BEXP4},  // S_BEXP3
  {SPR_BEXP,3|FF_FULLBRIGHT,10,{.pm = A_Explode},S_BEXP5},  // S_BEXP4
  ...
  {SPR_MISL,0|FF_FULLBRIGHT,1000,{.pm = A_Die},S_GRENADE},      // S_GRENADE

  // killough 8/10/98: variable damage explosion
  {SPR_MISL,1|FF_FULLBRIGHT,4,{.pm = A_Scream},S_DETONATE2},    // S_DETONATE
  {SPR_MISL,2|FF_FULLBRIGHT,6,{.pm = A_Detonate},S_DETONATE3},  // S_DETONATE2
  {SPR_MISL,3|FF_FULLBRIGHT,10,{NULL},S_NULL},            // S_DETONATE3

  // killough 7/19/98: Marine's best friend :)
  {SPR_DOGS,0,10,{.pm = A_Look},S_DOGS_STND2},  // S_DOGS_STND
  {SPR_DOGS,1,10,{.pm = A_Look},S_DOGS_STND}, // S_DOGS_STND2
  {SPR_DOGS,0,2,{.pm = A_Chase},S_DOGS_RUN2}, // S_DOGS_RUN1
  {SPR_DOGS,0,2,{.pm = A_Chase},S_DOGS_RUN3}, // S_DOGS_RUN2
  {SPR_DOGS,1,2,{.pm = A_Chase},S_DOGS_RUN4}, // S_DOGS_RUN3
  {SPR_DOGS,1,2,{.pm = A_Chase},S_DOGS_RUN5}, // S_DOGS_RUN4
  {SPR_DOGS,2,2,{.pm = A_Chase},S_DOGS_RUN6}, // S_DOGS_RUN5
  {SPR_DOGS,2,2,{.pm = A_Chase},S_DOGS_RUN7}, // S_DOGS_RUN6
  {SPR_DOGS,3,2,{.pm = A_Chase},S_DOGS_RUN8}, // S_DOGS_RUN7
  {SPR_DOGS,3,2,{.pm = A_Chase},S_DOGS_RUN1}, // S_DOGS_RUN8
  {SPR_DOGS,4,8,{.pm = A_FaceTarget},S_DOGS_ATK2},  // S_DOGS_ATK1
  {SPR_DOGS,5,8,{.pm = A_FaceTarget},S_DOGS_ATK3},  // S_DOGS_ATK2
  {SPR_DOGS,6,8,{.pm = A_SargAttack},S_DOGS_RUN1},  // S_DOGS_ATK3
  {SPR_DOGS,7,2,{NULL},S_DOGS_PAIN2}, // S_DOGS_PAIN
  {SPR_DOGS,7,2,{.pm = A_Pain},S_DOGS_RUN1},  // S_DOGS_PAIN2
  {SPR_DOGS,8,8,{NULL},S_DOGS_DIE2},  // S_DOGS_DIE1
  {SPR_DOGS,9,8,{.pm = A_Scream},S_DOGS_DIE3},  // S_DOGS_DIE2
  {SPR_DOGS,10,4,{NULL},S_DOGS_DIE4}, // S_DOGS_DIE3
  {SPR_DOGS,11,4,{.pm = A_Fall},S_DOGS_DIE5}, // S_DOGS_DIE4
...
#define OLDBFG_8FRAMES(x) OLDBFG_4FRAMES(x) OLDBFG_4FRAMES(x+4)
  ...
  // spawnstate
  {SPR_SKUL,0,10,{.pm = A_Look},S_BSKUL_STND},  // S_BSKUL_STND

  // chasestate
  {SPR_SKUL,1,5,{.pm = A_Chase},S_BSKUL_RUN2},  // S_BSKUL_RUN1
  {SPR_SKUL,2,5,{.pm = A_Chase},S_BSKUL_RUN3},  // S_BSKUL_RUN2
  {SPR_SKUL,3,5,{.pm = A_Chase},S_BSKUL_RUN4},  // S_BSKUL_RUN3
  {SPR_SKUL,0,5,{.pm = A_Chase},S_BSKUL_RUN1},  // S_BSKUL_RUN4

  // missilestate
  {SPR_SKUL,4,4,{.pm = A_FaceTarget},S_BSKUL_ATK2},     // S_BSKUL_ATK1
  {SPR_SKUL,5,5,{.pm = A_BetaSkullAttack},S_BSKUL_ATK3}, // S_BSKUL_ATK2
  {SPR_SKUL,5,4,{NULL},S_BSKUL_RUN1},              // S_BSKUL_ATK3

  // painstate
  {SPR_SKUL,6,4,{NULL},S_BSKUL_PAIN2},     // S_BSKUL_PAIN1
  {SPR_SKUL,7,2,{.pm = A_Pain},S_BSKUL_RUN1},   // S_BSKUL_PAIN2
  ...
  {SPR_SKUL,13,5,{.pm = A_Scream},S_BSKUL_DIE6}, // S_BSKUL_DIE5
  {SPR_SKUL,14,5,{NULL},S_BSKUL_DIE7},     // S_BSKUL_DIE6
  {SPR_SKUL,15,5,{.pm = A_Fall},S_BSKUL_DIE8},   // S_BSKUL_DIE7
  {SPR_SKUL,16,5,{.pm = A_Stop},S_BSKUL_DIE8},   // S_BSKUL_DIE8

  // killough 10/98: mushroom effect
  {SPR_MISL,1|FF_FULLBRIGHT,8,{.pm = A_Mushroom},S_EXPLODE2},  // S_MUSHROOM
};
